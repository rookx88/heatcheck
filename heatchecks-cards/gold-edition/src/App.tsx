        ...
        >
          ...
          >
            ...
            >
              ...
              <div
                className="absolute inset-0 rounded-xl overflow-hidden shadow-[0_0_40px_rgba(0,0,0,0.8)] border border-amber-500/70 bg-zinc-900 group"
                style={{ backfaceVisibility: 'hidden', transform: 'rotateY(180deg)' }}
              >
                {/* Gold plated cover art */}
                <img
                  src="/images/gold_plated_card.jpg"
                  alt="Gold plated card"
                ...
                <div className="absolute inset-0 bg-gradient-to-tr from-transparent via-amber-200/25 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-700 pointer-events-none mix-blend-overlay"></div>
