    ...
    return `
        ...
        @media (min-width: 1024px) {
            ...
            /* The logo stays IN FLOW above (so the world sits right under it, same
               slight overlap as mobile via the logo's negative bottom margin); only
               the row beneath it goes flex: map left, register CTA right. */
            #explore .hc-explore-wrap { margin-top: 0.5rem; }
            .hc-explore-row { display: flex; align-items: center; gap: 2rem; }
