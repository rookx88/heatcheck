...
CREATE TABLE IF NOT EXISTS events (
    ...
    event_type VARCHAR(50) NOT NULL,   -- 'page_view' | 'tank_opened' | 'wall_viewed' | 'pick_submitted' | 'pick_conflict' | 'email_verified' | 'newsletter_opt_in' | 'newsletter_opt_out' | 'newsletter_sent' | 'newsletter_exclusive_pick' | 'pick_settled' | 'email_unsubscribed' | 'sessions_revoked_others' | 'account_deleted' (full list: lib/pages-functions/events.ts)
