 ...
 * Always calculates using V4 -> V3 -> fallback to ensure consistency across all pages
 */
 ...
 */
function getTemperatureSymbol(heatScore) {
...
function generateMatchupButton(post) {
    ...
    // Always uses V4 -> V3 -> fallback calculation for consistency
